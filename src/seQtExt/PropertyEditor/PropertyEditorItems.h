...
class QT_PROPERTYEDITOR_EXPORT UnsignedIntProperty: public AbstractProperty<unsigned int>
{
public:
    UnsignedIntProperty(unsigned int value, const QString &name);

    QString specialValue() const;
    void setSpecialValue(const QString &specialValue);

    void setRange(unsigned int low, unsigned int hi);
...
class QT_PROPERTYEDITOR_EXPORT OsgVec3fProperty : public AbstractPropertyGroup
{
public:
				OsgVec3fProperty(const osg::Vec3f &value, const QString &name);
...
class QT_PROPERTYEDITOR_EXPORT OsgBoundingSphereProperty : public AbstractPropertyGroup
{
public:
				OsgBoundingSphereProperty(const osg::BoundingSphere& value, const QString &name);
